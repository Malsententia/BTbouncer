...
* Windows users: Download and extract [BTbouncer.zip](https://q-z.xzy/BTbouncer.zip), open that folder, then double click bt-bouncer.bat (this will take care of some prep stuff, as well as start the bouncer)
